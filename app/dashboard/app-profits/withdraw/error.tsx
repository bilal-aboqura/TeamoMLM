...
export default function AppProfitWithdrawError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="mx-auto max-w-md px-4 py-10 text-center" dir="rtl">
      <h2 className="text-xl font-bold text-slate-900">تعذر تحميل السحب</h2>
