        ...
        >
            ...
            {hasChildren ? (
              ...
              >
                <svg 
                  ...
                  viewBox="0 0 24 24"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d={collapsed ? "M12 4v16m8-8H4" : "M20 12H4"} />
                </svg>
              </button>
            ) : (
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className={`text-sm font-bold truncate max-w-[150px] sm:max-w-[200px] ${isRoot ? "text-white" : "text-slate-900"}`}>
                {node.full_name}
              </span>
              {node.leadership_level ? (
                <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-black tracking-widest ${
            ...
            <div className={`text-[10px] font-mono mt-0.5 tracking-wider ${isRoot ? "text-slate-400" : "text-slate-500"}`}>
              {node.referral_code}
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <div 
            ...
            style={{ 
              ...
              bottom: "28px" /* Stop line before the last child curve */
            }} 
          />
          <div>
