...
export default function ManageAppProfitsError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="rounded-2xl bg-white p-8 text-center">
      <h2 className="text-xl font-bold text-slate-900">تعذر تحميل عروض التطبيقات</h2>
